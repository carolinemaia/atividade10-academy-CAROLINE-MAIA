...
${TEXT_RESTORE}                     id=br.com.pztec.estoque:id/lbl_mensagem
${SELECIONAR_ARQUIVO_RESTORE}       id=br.com.pztec.estoque:id/btn_procurar
${ALERTA_TITULO}                    id=android:id/alertTitle
