...
${DRIVE}                xpath=(//android.widget.ImageView[@resource-id="android:id/icon"])[1]
${BLUETOOTH}            xpath=(//android.widget.ImageView[@resource-id="android:id/icon"])[2]
${GMAIL}                xpath=(//android.widget.ImageView[@resource-id="android:id/icon"])[3]
${MENSAGEM}             xpath=(//android.widget.ImageView[@resource-id="android:id/icon"])[4]
